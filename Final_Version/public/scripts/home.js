...
function startTimer(seconds) {
  ...
  const timerId = setInterval(() => {
    ...
    if (seconds === 0) {
      ...
      timerExpired(); //call function after timer finished
    }
  }, 1000);
}
...
// Function to generate a random number between min and max (filescount) 
...
function roll(){
  ...
  appData.setImgName = selectedImage + ".JPG" ;  
